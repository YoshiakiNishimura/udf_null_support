...
def main() -> None:
    with grpc.insecure_channel("127.0.0.1:50051") as channel:
        ...
        call_optional_add(stub, a_set=True, b_set=True, a_value=10, b_value=20)
        call_optional_add(stub, a_set=False, b_set=True, b_value=20)
        call_optional_add(stub, a_set=True, b_set=False, a_value=10)
        call_optional_add(stub, a_set=False, b_set=False)
        call_optional_add(stub, a_set=True, b_set=True, a_value=0, b_value=5)
